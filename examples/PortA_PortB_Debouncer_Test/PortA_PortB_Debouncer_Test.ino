/****************************************************************************
  PortA and PortB Debouncer Test Example:
  =======================================
  This example demonstrates how you can easily debounce two 8-bit ports
  (16 signals) at a time in just one Toggle object.

  This is the expected serial print for PortA with leading 0's added:
...
void setup() {
  ...
  for (int i = 0; i < 15; i++) {
    ...
    Serial.print(dat[i], BIN);
    Serial.print(F(" Out: "));
    Serial.println(sw1.debouncePortB(), BIN);
  }
}
